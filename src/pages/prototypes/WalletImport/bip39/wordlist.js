// The official BIP-39 English wordlist (2048 words, lexicographically
// sorted). Stored as whitespace-separated text so the module stays small and
// diffable; `suggest()` relies on the sort order for its binary search.
const WORDLIST_TEXT = `
...
const WORDLIST = WORDLIST_TEXT.trim().split(/\s+/)
